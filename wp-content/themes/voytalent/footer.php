...
<?php get_template_part( 'parts/s-share' ); ?>
...
<?php echo '<?xml version="1.0" encoding="UTF-8"?>'; ?>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        </symbol><symbol viewBox="0 0 24 24" id="voy-email" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 3v18h24V3H0zm21.518 2L12 12.713 2.482 5h19.036zM2 19V7.183l10 8.104 10-8.104V19H2z"/>
        </symbol><symbol viewBox="0 0 24 24" id="voy-facebook" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm3 8h-1.35c-.538 0-.65.221-.65.778V10h2l-.209 2H13v7h-3v-7H8v-2h2V7.692C10 5.923 10.931 5 13.029 5H15v3z"/></symbol><symbol viewBox="0 0 24 24" id="voy-linkedin" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-2 16H8v-6h2v6zM9 9.109c-.607 0-1.1-.496-1.1-1.109 0-.612.492-1.109 1.1-1.109s1.1.497 1.1 1.109c0 .613-.493 1.109-1.1 1.109zM17 16h-1.998v-2.861c0-1.881-2.002-1.722-2.002 0V16h-2v-6h2v1.093c.872-1.616 4-1.736 4 1.548V16z"/>
        </symbol>
        ...
        <symbol fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 24 24" id="voy-play" xmlns="http://www.w3.org/2000/svg">
        ...
        <symbol fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 24 24" id="voy-sound" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 23l-9.309-6H0V7h5.691L15 1v22zM6 7.991v8.018l8 5.157V2.834L6 7.991zm14.228-4.219A10.779 10.779 0 0 1 24 12.001a10.78 10.78 0 0 1-3.77 8.229l-.708-.708C21.658 17.731 23 15.021 23 12s-1.342-5.731-3.478-7.522l.706-.706zm-2.929 2.929A6.848 6.848 0 0 1 19.775 12a6.848 6.848 0 0 1-2.476 5.299l-.706-.706a5.861 5.861 0 0 0 2.182-4.591 5.861 5.861 0 0 0-2.184-4.593l.708-.708zM5 8H1v8h4V8z"/></symbol><symbol viewBox="0 0 24 24" id="voy-twitter" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.066 9.645c.183 4.04-2.83 8.544-8.164 8.544A8.127 8.127 0 0 1 5.5 16.898a5.778 5.778 0 0 0 4.252-1.189 2.879 2.879 0 0 1-2.684-1.995 2.88 2.88 0 0 0 1.298-.049c-1.381-.278-2.335-1.522-2.304-2.853.388.215.83.344 1.301.359a2.877 2.877 0 0 1-.889-3.835 8.153 8.153 0 0 0 5.92 3.001 2.876 2.876 0 0 1 4.895-2.62 5.73 5.73 0 0 0 1.824-.697 2.884 2.884 0 0 1-1.263 1.589 5.73 5.73 0 0 0 1.649-.453 5.765 5.765 0 0 1-1.433 1.489z"/></symbol><symbol viewBox="0 0 361 101.18" id="voy-voy-talent" xmlns="http://www.w3.org/2000/svg"><path d="M103 101.04H71l-71-71 22-23 49 49v-56h32v101zM251 101.04V.04h31v34l34-34 22 22-56 56v23h-31z"/><circle cx="345" cy="85.04" r="16"/><path d="M177 .04c-25-1-53.3 17.5-53 51 .29 33.26 29 52 53 50 24 2 52.71-16.74 53-50 .3-33.5-28-52-53-51zm0 73s-20 0-20-23 20-23 20-23 20 0 20 23-20 23-20 23z"/></symbol><symbol viewBox="0 0 24 24" id="voy-x" xmlns="http://www.w3.org/2000/svg"><path d="M23.954 21.03l-9.184-9.095 9.092-9.174L21.03-.046l-9.09 9.179L2.764.045l-2.81 2.81L9.14 11.96.045 21.144l2.81 2.81 9.112-9.192 9.18 9.1z"/></symbol></svg>
</figure>
