...
<!--         <div class="g-6">
        ...
        <!-- STYLED - Ken -->
        <div class="g-6">
          <input class="-full-width -input-file" name="resume_file" id="resume_file" type="file" accept="application/pdf" required>
            ...
            <span class="-input-file-desc">* Mandatory (Only .pdf, max 5mb.) </span>
        </div>
        <div class="g-6">
          <input class="-full-width -input-file" name="portfolio_file" id="portfolio_file" type="file" accept="application/pdf">
            ...
            <span class="-input-file-desc">(Only .pdf, max 5mb)</span>
        </div>
